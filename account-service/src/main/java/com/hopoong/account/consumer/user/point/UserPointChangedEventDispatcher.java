...
import com.hopoong.account.consumer.user.point.exception.UnsupportedUserPointChangedVersionException;
import com.hopoong.account.consumer.user.point.handler.UserPointChangedEventHandler;
